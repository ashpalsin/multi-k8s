docker build -t ashpalsin/multi-client:latest -t ashpalsin/multi-client:$SHA -f ./Dockerfile ./client
docker build -t ashpalsin/multi-server:latest -t ashpalsin/multi-server:$SHA -f ./Dockerfile ./server
docker build -t ashpalsin/multi-worker:latest -t ashpalsin/multi-worker:$SHA -f ./Dockerfile ./worker
